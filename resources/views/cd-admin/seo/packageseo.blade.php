...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>SEO for Package</h1>
     
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">SEO</a></li>
        <li class="active">Package SEO</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="margin-top: 20px">
            ...
            <center><h3 class="box-title">Add SEO For Package</h3></center>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
              ...
              <div class="form-group">
                  ...
                  <textarea type="text" class="form-control" name="sdes"  id="sdes" placeholder="Enter SEO Description">
                </textarea>
                </div>
